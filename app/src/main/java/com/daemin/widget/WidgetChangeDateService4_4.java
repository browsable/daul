 ...
 */
public class WidgetChangeDateService4_4 extends Service {
    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        int weekIndex = MyPreferences.USERINFO.getPref().getInt("weekIndex4_4", 0);
        int monthIndex = MyPreferences.USERINFO.getPref().getInt("monthIndex4_4", 0);
        Bitmap bitmap;
        ...
        wEditor.putInt("weekIndex4_4", weekIndex);
        wEditor.putInt("monthIndex4_4", monthIndex);
        wEditor.commit();
        bitmap.recycle();
