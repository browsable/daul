 ...
 */
public class DialSettingTimePicker extends Dialog {
    ...
    public DialSettingTimePicker(Context context, int position, String xth, String startHour, String startMin, String endHour, String endMin) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_setting_time_time);
        setCancelable(true);
