 ...
 */
public class BottomNormalListAdapter2 extends ArrayAdapter<BottomNormalData> {
    private LayoutInflater mInflater;

    public BottomNormalListAdapter2(Context context, List<BottomNormalData> values) {
        super(context, R.layout.listitem_normal2, values);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = mInflater.inflate(R.layout.listitem_normal2, parent, false);
