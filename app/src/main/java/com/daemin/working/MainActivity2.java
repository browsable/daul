...
public class MainActivity2 extends FragmentActivity {
    ...
    public void setTitle() {
        switcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                TextView myText = new TextView(MainActivity2.this);
    ...
    private void setLayout() {
        ...
        initSurfaceView = new InitSurfaceView2(this, viewMode);
    ...
    private InitSurfaceView2 initSurfaceView;
    ...
    private static MainActivity2 singleton;
    ...
    public void btPlusEvent(){
        ...
        dialogFlag = false;
        Intent i = new Intent(MainActivity2.this, DialSchedule.class);
        startActivity(i);
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
        if(User.INFO.getExplain1()) {
            Intent in = new Intent(MainActivity2.this, ExplainActivity.class);
            startActivity(in);
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
        }
    }
